...
public class NontificationsFragment extends Fragment {
    ...
    public void onViewCreated(@Nullable View view,@NonNull Bundle savedInstanceState){
        ...
        ImageView imageView1 =view.findViewById(R.id.back_tosettings);
        ...
        LinearLayout linearLayoutvideochats=view.findViewById(R.id.videochats);
        linearLayoutvideochats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                linearLayoutvideochats.setBackground(getResources().getDrawable(R.drawable.cornersnontsred));
            }
        });
